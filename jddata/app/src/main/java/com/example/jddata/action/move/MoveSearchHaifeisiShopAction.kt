...
open class MoveSearchHaifeisiShopAction(env: Env) : BaseAction(env, ActionType.MOVE_SEARCH_HAIFEISI_SHOP) {
    ...
    init {
        ...
        appendCommand(Command().commandCode(ServiceCommand.CLICK_SEARCH).addScene(AccService.JD_HOME))
                ...
                .append(Command().commandCode(ServiceCommand.SEARCH_SHOP).addScene(AccService.PRODUCT_LIST))
    }

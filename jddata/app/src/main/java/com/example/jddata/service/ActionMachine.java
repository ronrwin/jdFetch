...
public class ActionMachine {
    ...
    public ActionMachine(String actionType) {
        ...
        if (ActionType.SEARCH.equals(mCurrentActionType)) {
            ...
            input.setObj(MainApplication.sSearchText);
        ...
        } else if (ActionType.SEARCH_AND_SHOP.equals(mCurrentActionType)) {
            mCommandArrayList.add(new MachineState(AccService.JD_HOME,  ServiceCommand.CLICK_SEARCH));
            MachineState input = new MachineState(AccService.SEARCH,  ServiceCommand.INPUT);
            input.setObj(MainApplication.sSearchText);
            mCommandArrayList.add(input);
        ...
        else if (ActionType.CART.equals(mCurrentActionType)) {
        ...
        } else if (ActionType.HOME.equals(mCurrentActionType)) {
            mCommandArrayList.add(new MachineState(AccService.JD_HOME, ServiceCommand.HOME_SCROLL));
        } else if (ActionType.BRAND_KILL.equals(mCurrentActionType)) {
        ...
        } else if (ActionType.BRAND_KILL_AND_SHOP.equals(mCurrentActionType)) {
            BusHandler.getInstance().mBrandEntitys.clear();
            mCommandArrayList.add(new MachineState(AccService.JD_HOME, ServiceCommand.HOME_BRAND_KILL));
            mCommandArrayList.add(new MachineState(AccService.MIAOSHA, true, ServiceCommand.HOME_BRAND_KILL_SCROLL));
        } else if (ActionType.LEADERBOARD.equals(mCurrentActionType)) {
        ...
        } else if (ActionType.JD_KILL.equals(mCurrentActionType)) {
        ...
        } else if (ActionType.WORTH_BUY.equals(mCurrentActionType)) {
        ...
        } else if (ActionType.NICE_BUY.equals(mCurrentActionType)) {
        ...
        } else if (ActionType.TYPE_KILL.equals(mCurrentActionType)) {
        ...
        } else if (ActionType.DMP.equals(mCurrentActionType)) {

...
class FetchWorthBuyActionNoSku(env: Env) : BaseAction(env, ActionType.FETCH_WORTH_BUY) {
    ...
    fun collectTabs(): Int {
        ...
        val scrolls = AccessibilityUtils.findAccessibilityNodeInfosByViewId(mService, "com.jd.lib.worthbuy:id/a0e")

...
class FetchNicebuyNewAction(env: Env) : BaseAction(env, ActionType.FETCH_NICE_BUY_NEW) {
    ...
    fun saveData(currentProduct: Data2) {
        logFile?.writeToFileAppend("收集第${itemCount+1}商品：", currentProduct.arg1, currentProduct.arg2)

...
open class MoveSearchBolangShopMarkAction(env: Env) : BaseAction(env, ActionType.MOVE_SEARCH_BOLANG_SHOP_MARK) {
    ...
    init {
        ...
        appendCommand(Command().commandCode(ServiceCommand.CLICK_SEARCH).addScene(AccService.JD_HOME))
                ...
                .append(Command().commandCode(ServiceCommand.MARK).addScene(AccService.JSHOP)
                        .delay(3000))
    }
